...
public class KlinikaControllerTest {
    ...
    public void testPretragaKlinika() throws Exception {
        ...
        when(klinikaService.nadjiKlinikePoTipuPregledaNazivuIOceni(1, 0, "Klinika1")).thenReturn(klinike);
        ...
        verify(klinikaService, times(1)).nadjiKlinikePoTipuPregledaNazivuIOceni(1, 0, "Klinika1" );
