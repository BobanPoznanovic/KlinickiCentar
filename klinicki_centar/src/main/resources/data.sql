...
insert into lekar (klinikaID, ime, prezime, username, password, email, kontakt_telefon, adresa, pocetak_radnog_vremena, kraj_radnog_vremena, prosecna_ocena, broj_ocena, izmenjena_sifra_nakon_prvog_logovanja) values (1, "Zika", "Zikic", "zikson", "zikinasifra", "zika@gmail.com", "0645896214", "Novi Sad", '08:30', '16:30', 0, 0, true);
insert into lekar (klinikaID, ime, prezime, username, password, email, kontakt_telefon, adresa, pocetak_radnog_vremena, kraj_radnog_vremena, prosecna_ocena, broj_ocena, izmenjena_sifra_nakon_prvog_logovanja) values (1, "Mile", "Kovacevic", "mikan", "mika123", "mile@gmail.com", "064122333", "Novi Sad", '07:00', '15:00', 0, 0, true);
insert into lekar (klinikaID, ime, prezime, username, password, email, kontakt_telefon, adresa, pocetak_radnog_vremena, kraj_radnog_vremena, prosecna_ocena, broj_ocena, izmenjena_sifra_nakon_prvog_logovanja) values (3, "Lena", "Markovic", "marlena", "lena234", "lena@gmail.com", "0640096214", "Novi Sad", '09:30', '17:30', 0, 0, true);
insert into lekar (klinikaID, ime, prezime, username, password, email, kontakt_telefon, adresa, pocetak_radnog_vremena, kraj_radnog_vremena, prosecna_ocena, broj_ocena, izmenjena_sifra_nakon_prvog_logovanja) values (3, "Dejana", "Stokic", "dejana", "deja222", "dejana@gmail.com", "060999080", "Novi Sad", '08:00', '16:00', 0, 0, true);
insert into lekar (klinikaID, ime, prezime, username, password, email, kontakt_telefon, adresa, pocetak_radnog_vremena, kraj_radnog_vremena, prosecna_ocena, broj_ocena, izmenjena_sifra_nakon_prvog_logovanja) values (4, "Marko", "Lekovic", "male", "kkmm147", "marko@gmail.com", "0614452366", "Novi Sad", '09:00', '17:00', 0, 0, true);
insert into lekar (klinikaID, ime, prezime, username, password, email, kontakt_telefon, adresa, pocetak_radnog_vremena, kraj_radnog_vremena, prosecna_ocena, broj_ocena, izmenjena_sifra_nakon_prvog_logovanja) values (4, "Fedor", "Milic", "fele", "zzwert45", "fedor@gmail.com", "0635899665", "Novi Sad", '07:00', '15:00', 0, 0, true);
insert into lekar (klinikaID, ime, prezime, username, password, email, kontakt_telefon, adresa, pocetak_radnog_vremena, kraj_radnog_vremena, prosecna_ocena, broj_ocena, izmenjena_sifra_nakon_prvog_logovanja) values (4, "Julija", "Stankovic", "jules", "12vbbv", "julija@gmail.com", "0625894412", "Novi Sad", '07:00', '15:00', 0, 0, true);
