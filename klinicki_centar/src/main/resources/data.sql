...
insert into zahtev_za_registraciju (broj_osiguranika, email, password, ime, prezime, adresa, grad, drzava, broj_telefona, status_zahteva, razlog_odbijanja) values (1234, 'bobanpoznanovic1@gmail.com', 'perapera', 'Pera', 'Peric', 'Fruskogorska 1', 'Novi Sad', 'Srbija', '0601234', 1, '');
...
insert into lekar (klinikaID, ime, prezime, username, password, email, kontakt_telefon, adresa, pocetak_radnog_vremena, kraj_radnog_vremena, prosecna_ocena, broj_ocena, izmenjena_sifra_nakon_prvog_logovanja, version) values (1, "Mile", "Kovacevic", "mikan", "mika123", "mile@gmail.com", "064122333", "Novi Sad", '07:00', '15:00', 0.0, 0, false, 0);
insert into lekar (klinikaID, ime, prezime, username, password, email, kontakt_telefon, adresa, pocetak_radnog_vremena, kraj_radnog_vremena, prosecna_ocena, broj_ocena, izmenjena_sifra_nakon_prvog_logovanja, version) values (3, "Lena", "Markovic", "marlena", "lena234", "lena@gmail.com", "0640096214", "Novi Sad", '09:30', '17:30', 0.0, 0, false, 0);
insert into lekar (klinikaID, ime, prezime, username, password, email, kontakt_telefon, adresa, pocetak_radnog_vremena, kraj_radnog_vremena, prosecna_ocena, broj_ocena, izmenjena_sifra_nakon_prvog_logovanja, version) values (3, "Dejana", "Stokic", "dejana", "deja222", "dejana@gmail.com", "060999080", "Novi Sad", '08:00', '16:00', 0.0, 0, false, 0);
insert into lekar (klinikaID, ime, prezime, username, password, email, kontakt_telefon, adresa, pocetak_radnog_vremena, kraj_radnog_vremena, prosecna_ocena, broj_ocena, izmenjena_sifra_nakon_prvog_logovanja, version) values (4, "Marko", "Lekovic", "male", "kkmm147", "marko@gmail.com", "0614452366", "Novi Sad", '09:00', '17:00', 0.0, 0, false, 0);
...
insert into pregled (kategorija_pregleda, lekarID, pacijentID, salaID, datum_pregleda, satnica_pocetak, satnica_kraj, tip_pregledaID, popust, potvrdjen, zavrsen, lekar_ocenjen, klinika_ocenjena) values ("Normalan", 1, 1, 1, '2020-06-19', '09:00', '09:29', 1, 0, false, true, false, false);
insert into pregled (kategorija_pregleda, lekarID, pacijentID, salaID, datum_pregleda, satnica_pocetak, satnica_kraj, tip_pregledaID, popust, potvrdjen, zavrsen, lekar_ocenjen, klinika_ocenjena) values ("Normalan", 1, 1, 1, '2020-06-19', '09:30', '09:59', 1, 0, false, true, false, false);
...
insert into pregled (kategorija_pregleda, lekarID, pacijentID, salaID, datum_pregleda, satnica_pocetak, satnica_kraj, tip_pregledaID, popust, potvrdjen, zavrsen, lekar_ocenjen, klinika_ocenjena) values ("Normalan", 6, 2, 11, '2020-07-03', '08:30', '09:29', 1, 0, false, false, false, false);

insert into pregled (kategorija_pregleda, lekarID, pacijentID, salaID, datum_pregleda, satnica_pocetak, satnica_kraj, tip_pregledaID, popust, potvrdjen, zavrsen, lekar_ocenjen, klinika_ocenjena) 
			values ("Predefinisan", 1, null, 1, '2020-06-26', '12:00', '12:59', 1, 200, false, false, false, false);
insert into pregled (kategorija_pregleda, lekarID, pacijentID, salaID, datum_pregleda, satnica_pocetak, satnica_kraj, tip_pregledaID, popust, potvrdjen, zavrsen, lekar_ocenjen, klinika_ocenjena) 
			values ("Predefinisan", 2, null, 3, '2020-06-29', '12:00', '12:29', 2, 200, false, false, false, false);
insert into pregled (kategorija_pregleda, lekarID, pacijentID, salaID, datum_pregleda, satnica_pocetak, satnica_kraj, tip_pregledaID, popust, potvrdjen, zavrsen, lekar_ocenjen, klinika_ocenjena) 
			values ("Predefinisan", 3, null, 5, '2020-07-01', '10:00', '10:59', 6, 300, false, false, false, false);
insert into pregled (kategorija_pregleda, lekarID, pacijentID, salaID, datum_pregleda, satnica_pocetak, satnica_kraj, tip_pregledaID, popust, potvrdjen, zavrsen, lekar_ocenjen, klinika_ocenjena) 
			values ("Predefinisan", 4, null, 7, '2020-07-14', '13:00', '13:59', 7, 150, false, false, false, false);
insert into pregled (kategorija_pregleda, lekarID, pacijentID, salaID, datum_pregleda, satnica_pocetak, satnica_kraj, tip_pregledaID, popust, potvrdjen, zavrsen, lekar_ocenjen, klinika_ocenjena) 
			values ("Predefinisan", 6, null, 11, '2020-06-22', '10:00', '10:29', 1, 200, false, false, false, false);
insert into pregled (kategorija_pregleda, lekarID, pacijentID, salaID, datum_pregleda, satnica_pocetak, satnica_kraj, tip_pregledaID, popust, potvrdjen, zavrsen, lekar_ocenjen, klinika_ocenjena) 
			values ("Predefinisan", 7, null, 13, '2020-07-06', '14:00', '14:29', 1, 200, false, false, false, false);
...
insert into operacija (lekarID, datum_operacije, satnica_pocetka_operacije, satnica_kraja_operacije, salaID, pacijentID, lekar_ocenjen, klinika_ocenjena) 
			   values (3, '2020-06-28', '14:00', '14:59', 6, 1, false, false);
insert into operacija (lekarID, datum_operacije, satnica_pocetka_operacije, satnica_kraja_operacije, salaID, pacijentID, lekar_ocenjen, klinika_ocenjena) 
			   values (4, '2020-07-27', '15:30', '15:59', 8, 1, false, false);
insert into operacija (lekarID, datum_operacije, satnica_pocetka_operacije, satnica_kraja_operacije, salaID, pacijentID, lekar_ocenjen, klinika_ocenjena) 
			   values (5, '2020-07-23', '11:00', '11:59', 10, 2, false, false);
insert into operacija (lekarID, datum_operacije, satnica_pocetka_operacije, satnica_kraja_operacije, salaID, pacijentID, lekar_ocenjen, klinika_ocenjena) 
			   values (5, '2020-07-22', '14:00', '14:59', 12, 2, false, false);
insert into operacija (lekarID, datum_operacije, satnica_pocetka_operacije, satnica_kraja_operacije, salaID, pacijentID, lekar_ocenjen, klinika_ocenjena) 
			   values (5, '2020-07-27', '15:30', '15:59', 14, 2, false, false);
insert into operacija (lekarID, datum_operacije, satnica_pocetka_operacije, satnica_kraja_operacije, salaID, pacijentID, lekar_ocenjen, klinika_ocenjena) 
			   values (6, '2020-06-23', '11:00', '11:59', 16, 2, false, false);
insert into operacija (lekarID, datum_operacije, satnica_pocetka_operacije, satnica_kraja_operacije, salaID, pacijentID, lekar_ocenjen, klinika_ocenjena) 
			   values (7, '2020-06-22', '14:00', '14:59', 16, 2, false, false);
